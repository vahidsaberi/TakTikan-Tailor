...
using TakTikan.Tailor.UiCustomization;
using TakTikan.Tailor.UiCustomization.Dto;

namespace TakTikan.Tailor.Web.TagHelpers
{
    ...
    public class TailorPageSubheaderTagHelper : TagHelper
    {
        ...
        public TailorPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
