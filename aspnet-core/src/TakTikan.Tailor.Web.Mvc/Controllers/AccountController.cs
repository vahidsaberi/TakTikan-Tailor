...
using TakTikan.Tailor.Authentication.TwoFactor.Google;
using TakTikan.Tailor.Authorization;
using TakTikan.Tailor.Authorization.Accounts;
using TakTikan.Tailor.Authorization.Accounts.Dto;
using TakTikan.Tailor.Authorization.Delegation;
using TakTikan.Tailor.Authorization.Impersonation;
using TakTikan.Tailor.Authorization.Users;
using TakTikan.Tailor.Configuration;
using TakTikan.Tailor.Debugging;
using TakTikan.Tailor.Identity;
using TakTikan.Tailor.MultiTenancy;
using TakTikan.Tailor.Net.Sms;
using TakTikan.Tailor.Notifications;
using TakTikan.Tailor.Web.Models.Account;
using TakTikan.Tailor.Security;
using TakTikan.Tailor.Security.Recaptcha;
using TakTikan.Tailor.Sessions;
using TakTikan.Tailor.Url;
using TakTikan.Tailor.Web.Authentication.External;
using TakTikan.Tailor.Web.Security.Recaptcha;
using TakTikan.Tailor.Web.Session;
using TakTikan.Tailor.Web.Views.Shared.Components.TenantChange;

namespace TakTikan.Tailor.Web.Controllers
{
    public class AccountController : TailorControllerBase
    {
