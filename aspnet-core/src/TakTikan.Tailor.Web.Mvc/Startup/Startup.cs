...
using TakTikan.Tailor.Web.Common;
using TakTikan.Tailor.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using TakTikan.Tailor.Web.IdentityServer;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerDoc("v1", new OpenApiInfo() {Title = "Tailor API", Version = "v1"});
            ...
            return services.AddAbp<TailorWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "Tailor API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("TakTikan.Tailor.Web.wwwroot.swagger.ui.index.html");
