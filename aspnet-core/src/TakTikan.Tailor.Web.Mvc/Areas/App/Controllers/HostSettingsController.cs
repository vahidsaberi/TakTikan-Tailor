...
using TakTikan.Tailor.Configuration.Host;
using TakTikan.Tailor.Editions;
using TakTikan.Tailor.Timing;
using TakTikan.Tailor.Timing.Dto;
using TakTikan.Tailor.Web.Areas.App.Models.HostSettings;
...
namespace TakTikan.Tailor.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : TailorControllerBase
    {
