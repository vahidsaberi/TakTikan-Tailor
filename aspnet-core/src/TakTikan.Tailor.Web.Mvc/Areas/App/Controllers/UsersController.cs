...
using TakTikan.Tailor.Authorization.Permissions;
...
using TakTikan.Tailor.Web.Areas.App.Models.Roles;
using TakTikan.Tailor.Web.Areas.App.Models.Users;
...
namespace TakTikan.Tailor.Web.Areas.App.Controllers
{
    ...
    public class UsersController : TailorControllerBase
    {
