...
namespace TakTikan.Tailor.Web.Areas.App.Views.Shared.Themes.Theme3.Components.AppTheme3Footer
{
    public class AppTheme3FooterViewComponent : TailorViewComponent
    {
