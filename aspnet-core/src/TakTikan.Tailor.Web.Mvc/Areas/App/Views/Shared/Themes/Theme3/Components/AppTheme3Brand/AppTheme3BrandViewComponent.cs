...
namespace TakTikan.Tailor.Web.Areas.App.Views.Shared.Themes.Theme3.Components.AppTheme3Brand
{
    public class AppTheme3BrandViewComponent : TailorViewComponent
    {
