...
namespace TakTikan.Tailor.Core.Base
{
    public abstract class TailorQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected TailorQueryBase(string fieldName,
