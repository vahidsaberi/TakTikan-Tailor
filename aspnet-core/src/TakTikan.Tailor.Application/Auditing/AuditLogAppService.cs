...
using TakTikan.Tailor.Auditing.Exporting;
...
using EntityHistoryHelper = TakTikan.Tailor.EntityHistory.EntityHistoryHelper;

namespace TakTikan.Tailor.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : TailorAppServiceBase, IAuditLogAppService
    {
