...
using TakTikan.Tailor.Authorization.Users.Profile.Cache;
    ...
    public class ProfileAppService : TailorAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("TakTikan.Tailor",
