...
using TakTikan.Tailor.DemoUiComponents.Dto;

namespace TakTikan.Tailor.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : TailorAppServiceBase, IDemoUiComponentsAppService
    {
