...
{
    public class SessionAppService : TailorAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = TailorConsts.Currency,
                    CurrencySign = TailorConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = TailorConsts.AllowTenantsToChangeEmailSettings,
