...
using TakTikan.Tailor.Commands;
using TakTikan.Tailor.Core.Threading;
using TakTikan.Tailor.Models.NavigationMenu;
using TakTikan.Tailor.Services.Navigation;
using TakTikan.Tailor.ViewModels.Base;
using Plugin.Media;
...
using TakTikan.Tailor.Controls;
using TakTikan.Tailor.Dto;
using TakTikan.Tailor.Extensions;
using TakTikan.Tailor.Localization;
using TakTikan.Tailor.UI;
using TakTikan.Tailor.UI.Assets;
using TakTikan.Tailor.Views;
using DependencyResolver = TakTikan.Tailor.Core.Dependency.DependencyResolver;

namespace TakTikan.Tailor.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Tailor";
