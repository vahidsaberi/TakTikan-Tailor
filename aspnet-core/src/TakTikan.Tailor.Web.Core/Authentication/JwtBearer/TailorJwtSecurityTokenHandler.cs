...
namespace TakTikan.Tailor.Web.Authentication.JwtBearer
{
    public class TailorJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public TailorJwtSecurityTokenHandler()
        {
