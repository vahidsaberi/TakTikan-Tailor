...
using TakTikan.Tailor.Authorization.Ldap;
...
using TakTikan.Tailor.DashboardCustomization.Definitions;
using TakTikan.Tailor.Debugging;
using TakTikan.Tailor.DynamicEntityProperties;
using TakTikan.Tailor.Features;
...
using TakTikan.Tailor.Net.Emailing;
using TakTikan.Tailor.Notifications;
using TakTikan.Tailor.WebHooks;

namespace TakTikan.Tailor
{
    [DependsOn(
        typeof(TailorCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class TailorCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            TailorLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = TailorConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, TailorMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<TailorSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TailorCoreModule).GetAssembly());
        }
