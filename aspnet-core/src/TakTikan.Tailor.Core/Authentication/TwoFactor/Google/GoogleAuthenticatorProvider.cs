...
namespace TakTikan.Tailor.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : TailorServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("TakTikan.Tailor", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
