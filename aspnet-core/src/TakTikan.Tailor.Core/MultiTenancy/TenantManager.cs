...
using TakTikan.Tailor.MultiTenancy.Demo;
...
namespace TakTikan.Tailor.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(TailorConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(TailorConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
