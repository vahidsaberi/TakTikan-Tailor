...
{
    public class StripeGatewayManager : TailorServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Tailor";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + TailorConsts.Currency;
        }
