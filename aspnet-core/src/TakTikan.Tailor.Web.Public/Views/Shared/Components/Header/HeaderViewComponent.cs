...
using TakTikan.Tailor.Web.Public.Startup;
using TakTikan.Tailor.Web.Session;

namespace TakTikan.Tailor.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : TailorViewComponent
    {
