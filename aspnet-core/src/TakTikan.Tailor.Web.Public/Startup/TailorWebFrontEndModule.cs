...
namespace TakTikan.Tailor.Web.Public.Startup
{
    [DependsOn(
        typeof(TailorWebCoreModule)
    )]
    public class TailorWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public TailorWebFrontEndModule(IWebHostEnvironment env, TailorEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TailorWebFrontEndModule).GetAssembly());
        }
    }
}
