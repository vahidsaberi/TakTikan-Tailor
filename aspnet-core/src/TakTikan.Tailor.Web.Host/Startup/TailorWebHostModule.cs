...
using TakTikan.Tailor.Web.Startup.ExternalLoginInfoProviders;
...
namespace TakTikan.Tailor.Web.Startup
{
    ...
    public class TailorWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public TailorWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TailorWebHostModule).GetAssembly());
        }
