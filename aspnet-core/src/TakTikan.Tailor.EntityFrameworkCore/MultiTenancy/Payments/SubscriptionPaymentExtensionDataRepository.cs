...
using TakTikan.Tailor.EntityFrameworkCore.Repositories;

namespace TakTikan.Tailor.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : TailorRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<TailorDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
