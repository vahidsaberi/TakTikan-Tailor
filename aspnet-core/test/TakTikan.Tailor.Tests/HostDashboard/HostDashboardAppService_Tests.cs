...
using TakTikan.Tailor.MultiTenancy.HostDashboard;
...
namespace TakTikan.Tailor.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(TailorDbContext context, SubscriptionPayment subscriptionPayment)
        {
