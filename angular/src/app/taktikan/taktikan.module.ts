...
import { TakTikanRoutingModule } from './taktikan-routing.module';
...
@NgModule({
    ...
    declarations: [
        FabricCutComponent,
        FabricMaterialComponent,
        FabricRollComponent,
        FabricTypeComponent,
        GenderComponent,
        SalineStoneComponent,
        SalineStoneOrderComponent,
        SeamstressComponent,
        SewnPieceComponent
    ],
    exports: [
